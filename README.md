<h1 align="center">「 C# 」- QuantidadeProdutos_Ⅰ</h1>
...
Este projeto utiliza alguns conceitos do c# como declaração de variáveis, estruturas condicionais (if/else) e switch case.
